...
- **Last updated:** 2026-05-04 by Claude (commit pending — GSTR-2B reconcile)
...
| Date | What | Commit |
|---|---|---|
| 2026-05-04 | **WS2 — GSTR-2B reconciliation.** New `parseGstr2bJson` + `matchGstr2bToBills` (pure helpers). `POST /gst-returns/gstr2b/reconcile` accepts the GSTN 2B JSON, classifies every B2B invoice as MATCHED / MISMATCHED / MISSING_IN_BOOKS / MISSING_IN_2B with reasons. ₹1 per-cell tolerance. +16 tests (299 total). | _pending_ |
