...
- **Last updated:** 2026-05-04 by Claude (commit pending — payroll pay-month)
...
| Date | What | Commit |
|---|---|---|
| 2026-05-04 | **WS7 — payroll pay-month settles Salaries Payable.** New `POST /payroll/pay-month` validates period is fully PROCESSED, posts Dr Salaries Payable / Cr Bank, decrements BankAccount, moves payslips to PAID. Refuses partial-paid periods (defensive). | _pending_ |
