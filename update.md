...
- **Last updated:** 2026-05-04 by Claude (commit pending — bill→GL posting w/ RCM + TDS-at-bill)
...
| Date | What | Commit |
|---|---|---|
| 2026-05-04 | **Bill → GL posting (architectural).** Migration 8 (Bill.voucherId, Bill.tdsSection, TdsDeduction.billId). New pure `decideBillEntries` (4-way Dr=Cr invariants) + `postBillToGl` covering regular / RCM / composition / TDS-at-bill. Wired into bills POST + maybePromoteEntity. +9 tests (336 total). | _pending_ |
