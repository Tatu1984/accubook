...
- **Last updated:** 2026-05-04 by Claude (commit pending — TDS/TCS persistence)
...
| Date | What | Commit |
|---|---|---|
| 2026-05-04 | **WS5 — TDS/TCS persistence tables + Form 16A/27D aggregator.** New `TdsDeduction` + `TcsCollection` models (migration 5). Populated inside payments + receipts $transactions. Two GET endpoints with list-or-aggregate views. New `buildForm16AQuarterly` + 16 tests (271 total). | _pending_ |
